let handler = async(m, { conn, args, usedPrefix }) => {
    ...
    if (args[0] == 'OshdnpGaka' || args[0] == '2004' || args[0] == '2006' || args[0] == 'fghiul' || args[0] == 'A820bdoqP' || args[0] == 'hkihswu' || args[0] == 'bh!kaiyin' || args[0] == 'PagpqvUac' || args[0] == '91hakHcwo' || args[0] == 'A820bdoqP') {
