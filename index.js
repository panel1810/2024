...
// Console
let bot = global.namebot
let own = global.nameown
...
console.log(color(`${spc3}                    [•]`, randomcolor), color(`Hai         : i.m ${bot}`, randomcolor));
...
console.log(color(`${spc3}                    [•]`, randomcolor), color(`Owner       : ${own}`, randomcolor));
...
console.log(color(`${spc4}                       < =============================== >`, randomcolor));
console.log(chalk.bgWhite(chalk.blue('Sabar lagi Loding')))
var date = new Date();
...
console.log(chalk.bgWhite(chalk.blue(tampilTanggal)))
console.log(chalk.bgWhite(chalk.blue(tampilWaktu)))
console.log(chalk.bgWhite(chalk.blue(tampilHari)))
var isRunning = false
/**
 * Start a js file
...
console.log(chalk.bgWhite(chalk.blue('[✅RECEIVED]', data)))
switch (data) {
case 'reset':
p.kill()
isRunning = false
